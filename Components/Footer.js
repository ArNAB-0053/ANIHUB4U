        ...
        <div className='flex items-center'>
          ...
          <div className="links grid place-items-center grid-cols-2 grid-rows-2 gap-2 px-2 py-4">
            <Link className='linksCon bg-[#dadada] dark:bg-[#2d2d2daa] p-[1.3rem]' id='link1' href="https://t.me/your-telegram-channel">
              <svg id='linkIcon' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-telegram text-black dark:text-white" viewBox="0 0 16 16">
            ...
            <Link className='linksCon bg-[#dadada] dark:bg-[#2d2d2daa] p-[1.3rem]' id='link2' href="https://twitter.com/your-twitter-handle">
              <svg id='linkIcon' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter text-black dark:text-white" viewBox="0 0 16 16">
            ...
            <Link className='linksCon bg-[#dadada] dark:bg-[#2d2d2daa] p-[1.3rem]' id='link3' href="https://github.com/ArNAB-0053/ANIHUB4U">
              <svg id='linkIcon' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-github text-black dark:text-white" viewBox="0 0 16 16">
            ...
            <Link className='linksCon bg-[#dadada] dark:bg-[#2d2d2daa] p-[1.3rem]' id='link4' href="https://www.instagram.com/__arnab_bhattacharyya/">
              <svg id='linkIcon' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-instagram text-black dark:text-white" viewBox="0 0 16 16">
