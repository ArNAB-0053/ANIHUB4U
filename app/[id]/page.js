    ...
    return (
        <div>
            {loading ? (
                ...
                <div className="mainContainer flex flex-col items-center justify-center min-h-screen text-white w-[90vw] mx-16 mt-16">
                    <h1 className="titleHead text-black dark:text-white text-center">{title}</h1>

                    <div className="animeDetails rounded-xl flex items-center justify-center flex-col w-full 
                    bg-[url('/Images/TG/1.jpg')]">
                        <div className="__animeDetails dark:bg-[#3d3d3dc4] bg-[#dadadac4]">
